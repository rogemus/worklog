...
func TestTest(t *testing.T) {
	tests := map[string]struct {
		...
		"task with branch and tags": {
			...
			out: `[2006-01-02 15:04:00] Task Name @tags:feat,ui @branch:master`,
		},
		"task with branch, repo, tags": {
			...
			out: `[2006-01-02 15:04:00] Task Name @tags:feat,ui @repo:super-repo @branch:master`,
		},
		"task with branch, repo, issue_id, tags": {
			...
			out: `[2006-01-02 15:04:00] Task Name @tags:feat,ui @issue_id:XXX-123 @repo:super-repo @branch:master`,
		},
	}

	for testName, test := range tests {
		t.Run(testName, func(t *testing.T) {
			taskStr := test.in.ToString()
